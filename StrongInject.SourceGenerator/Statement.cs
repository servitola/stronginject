...
namespace StrongInject.Generator
{
    ...
    internal sealed record SingleInstanceReferenceStatement(string VariableName, InstanceSource Source, bool IsAsync)
        : Statement;

    internal sealed record InitializationStatement(string? VariableName, string VariableToInitializeName, bool IsAsync)
        : Statement;
