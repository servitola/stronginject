...
namespace StrongInject.Generator
{
    ...
    {
        public const string IREQUIRES_INITIALIZATION_EMIT_NAME = "StrongInject.IRequiresInitialization";
        public const string IREQUIRES_ASYNC_INITIALIZATION_EMIT_NAME = "StrongInject.IRequiresAsyncInitialization";
        public const string HELPERS_EMIT_NAME = "StrongInject.Helpers";

        public const string IDISPOSABLE_EMIT_NAME = "IDisposable";
        public const string IASYNC_DISPOSABLE_EMIT_NAME = "IAsyncDisposable";

        public const string CONCURRENT_BAG_ACTION_EMIT_NAME =
            "System.Collections.Concurrent.ConcurrentBag<Action>";

        public const string CONCURRENT_BAG_FUNC_TASK_EMIT_NAME =
            "System.Collections.Concurrent.ConcurrentBag<Func<ValueTask>>";

        public const string VALUE_TASK_EMIT_NAME = "ValueTask";
        public const string OBJECT_DISPOSED_EXCEPTION_EMIT_NAME = "ObjectDisposedException";
        ...
        public static string ConstructedOwnedEmitName(string typeArgument)
        {
            return $"global::StrongInject.Owned<{typeArgument}>";
        }

        public static string ConstructedAsyncOwnedEmitName(string typeArgument)
        {
            return $"global::StrongInject.AsyncOwned<{typeArgument}>";
        }

        public static string ConstructedValueTask1EmitName(string typeArgument)
        {
            return $"global::System.Threading.Tasks.ValueTask<{typeArgument}>";
        }

        public static string ConstructedOwnedDisplayName(string typeArgument)
        {
            return $"StrongInject.Owned<{typeArgument}>";
        }

        public static string ConstructedAsyncOwnedDisplayName(string typeArgument)
        {
            return $"StrongInject.AsyncOwned<{typeArgument}>";
        }

        public static bool TryCreate(
            Compilation compilation,
            Action<Diagnostic> reportDiagnostic,
            out WellKnownTypes wellKnownTypes)
        {
            ...
            wellKnownTypes = new WellKnownTypes(owned, asyncOwned);
        ...
        private static (string identifier, int arity) GetIdentifier(NameSyntax name)
        {
            var simpleName = name switch
            {
                ...
                var other => throw new NotSupportedException(other.GetType().ToString()),
            };
