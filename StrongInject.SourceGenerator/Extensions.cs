...
namespace StrongInject.Generator
{
    internal static class Extensions
    {
        ...
        {
            return new HashSet<T>(@this, equalityComparer);
        }
        ...
        public static void CreateOrUpdate<TKey, TValue, TParam>(
            this Dictionary<TKey, TValue> dic,
            TKey key,
            TParam param,
            Func<TKey, TParam, TValue> create,
            Func<TKey, TParam, TValue, TValue> update)
        {
        ...
        public static TValue GetOrCreate<TKey, TState, TValue>(
            this Dictionary<TKey, TValue> dic,
            TKey key,
            TState state,
        ...
        public static void WithInstanceSource(
            this Dictionary<ITypeSymbol, InstanceSources> instanceSources,
        ...
        public static IEnumerable<TResult> SelectWhere<TSource, TResult>(
            ...
            Func<TSource, (bool, TResult)> whereSelector)
        {
