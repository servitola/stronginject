...
namespace StrongInject.Generator
{
    ...
    {
        private static DiagnosticDescriptor MissingTypeDescriptor => new(
            "SI0201",
            "Missing Type",
        ...
        public static INamedTypeSymbol? GetTypeOrReport(
        ...
        public static bool IsAccessibleInternally(this ITypeSymbol type)
        {
            ...
            return type switch
            {
                ...
                INamedTypeSymbol named => named.DeclaredAccessibility is Accessibility.Public
                                              or Accessibility.ProtectedOrInternal or Accessibility.Internal
        ...
        public static bool IsPublic(this ITypeSymbol type)
        {
            ...
            return type switch
            {
                ...
                INamedTypeSymbol named => named.DeclaredAccessibility == Accessibility.Public &&
                                          (named.IsUnboundGenericType || named.TypeArguments.All(IsPublic)),
                _ => false,
            };
        }
        ...
        public static bool HasAtMostInternalVisibility(this ITypeSymbol type)
        {
            ...
            return type switch
            {
                ...
                INamedTypeSymbol named => named.DeclaredAccessibility is Accessibility.Internal or Accessibility.Private
        ...
        {
            return type.ToDisplayString(
                new SymbolDisplayFormat(genericsOptions: SymbolDisplayGenericsOptions.IncludeTypeParameters));
        }

        public static Location GetLocation(this AttributeData attributeData, CancellationToken cancellationToken)
        {
            return attributeData.ApplicationSyntaxReference?.GetSyntax(cancellationToken).GetLocation() ?? Location.None;
        }

        public static bool IsWellKnownTaskType(
            this ITypeSymbol type,
            WellKnownTypes wellKnownTypes,
            out ITypeSymbol taskOfType)
        {
