    ...
    internal class RequiresAsyncChecker
    {
        ...
        public bool RequiresAsync(InstanceSource source)
        {
            return _cache.GetOrCreate(
                source,
                (_containerScope, _cancellationToken),
                static (i, s) => Visitor.RequiresAsync(i, s._containerScope, s._cancellationToken));
        }
        ...
        private class Visitor : SimpleVisitor
        {
            ...
            private Visitor(InstanceSourcesScope containerScope, CancellationToken cancellationToken)
                : base(
                    containerScope,
                    cancellationToken)
            {
            ...
            public static bool RequiresAsync(
